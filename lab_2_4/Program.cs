    ...
    class Program
    {
        ...
        private static void ShipmentMenu(ShipmentService shipmentService)
        {
            ...
            do
            {
                ...
                Console.WriteLine("5. Sort shipments by weight");
                Console.WriteLine("0. Back to main menu");
                ...
                switch (option)
                {
                    ...
                    case "4":
                        ...
                        break;
                    case "5":
                        shipmentService.ListShipmentByWeight();
                        break;
                    case "0":
                        break;
                    default:
        ...
        private static void PackageMenu(PackageService packageService)
        {
            ...
            do
            {
                ...
                Console.WriteLine("2. List all Packages with Explicit Loading");
                Console.WriteLine("3. List all Packages with Eager Loading");
                Console.WriteLine("4. Create a new Package");
                Console.WriteLine("5. Update an existing Package");
                Console.WriteLine("6. Delete a Package");
                Console.WriteLine("0. Back to main menu");
                ...
                switch (option)
                {
                    case "1":
                        ...
                        break;
                    case "2":
                        packageService.LoadPackagesWithExplicitLoading();
                        break;
                    case "3":
                        packageService.LoadPackagesWithEagerLoading();
                        break;
                    case "4":
