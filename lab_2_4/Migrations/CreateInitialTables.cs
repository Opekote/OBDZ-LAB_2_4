    ...
    public class CreateInitialTables : Migration
    {
        public override void Up()
        {
            ...
            Create.Table("shipment")
                ...
                .WithColumn("packageid").AsInt64().Nullable(); // Added PackageID column
            ...
            Create.ForeignKey("fk_package_shipment")
                .FromTable("package").ForeignColumn("shipmentid")
                .ToTable("shipment").PrimaryColumn("shipmentid")
                .OnDelete(System.Data.Rule.Cascade);

            Create.ForeignKey("fk_shipment_package")
                .FromTable("shipment").ForeignColumn("packageid")
                .ToTable("package").PrimaryColumn("packageid")
                .OnDelete(System.Data.Rule.Cascade);
        }
        ...
        public override void Down()
        {
            ...
            Delete.ForeignKey("fk_package_shipment").OnTable("package");
            Delete.ForeignKey("fk_shipment_package").OnTable("shipment");
